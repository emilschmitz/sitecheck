...
Automated OSINT pipeline with an A2A-compatible custom agent and an MCP server inspired by legal use cases.
...
### Manually triggering the Audit via A2A over curl
